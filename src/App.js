...
const GradeCheck = () => {
  ...
  function checkGrade() {
    let final =
      (gradeWanted - (currentGrade * (100.0 - gradeWeight)) / 100.0) /
      (gradeWeight / 100.0);
    ...
    <Container className={classes.container} display="flex">
      ...
      >
        ...
        <TextField
          ...
          onChange={(event) => setGradeWanted(event.target.value)}
          InputProps={{
            endAdornment: <InputAdornment position="end">%</InputAdornment>,
          }}
        />
        ...
        <RadioGroup className={classes.radio}>
          <FormControlLabel
            ...
            control={<StyledRadio />}
            label="Test/Quiz"
            onClick={(event) => setGradeWeight("70")}
          />
          <FormControlLabel
            value="Classwork/Homework"
            control={<StyledRadio />}
            label="Class/Homework"
            onClick={(event) => setGradeWeight("30")}
          />
        </RadioGroup>
      </form>
      ...
      <Box>
        ...
        <Typography
          variant="h4"
          component="h4"
          className={classes.typographyGrade}
        >
          {finalGrade}%
        </Typography>
      </Box>
